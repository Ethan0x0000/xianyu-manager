...
const LOCAL_VERSION_HISTORY = {
    version: 'v0.1.0',
    intro: 'xianyu-manager 版本基线已重置为 0.1.0，本系统仅供个人学习研究使用，请勿用于商业用途。',
    versionHistory: [
        {
            version: 'v0.1.0',
            date: '2026-04-06',
            updates: [
                '【变更】仓库与镜像命名统一调整为 xianyu-manager',
                '【变更】前后端展示版本统一重置为 0.1.0',
                '【变更】本地更新历史从 0.1.0 重新开始维护'
            ]
        }
    ]
};
