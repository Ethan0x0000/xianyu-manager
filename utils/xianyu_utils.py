...
def get_js_path():
    ...
    js_path = os.path.join(root_dir, "app", "protocol", "xianyu_js_version_2.js")
    return js_path
...
def decrypt(data: str) -> str:
    ...
    try:
        ...
        try:
            ...
            data = data.encode("utf-8", errors="ignore").decode(
                "ascii", errors="ignore"
            )
        ...
        if isinstance(decoded_value, dict):
            ...
            return json_module.dumps(
                decoded_value, default=json_serializer, ensure_ascii=False
            )
